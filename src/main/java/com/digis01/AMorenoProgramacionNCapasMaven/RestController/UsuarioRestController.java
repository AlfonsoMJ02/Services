...
//    @ResponseBody
//    public ResponseEntity<Result> UpdateImagen(@RequestParam("idUsuario") int idUsuario, @RequestParam("imagenFile") MultipartFile imagenFile, Authentication auth) {
//
//        try {
//
//            String imagenBase64 = Base64.getEncoder().encodeToString(imagenFile.getBytes());
//
//            Result result = usuarioJPADAO.UpdateImagen(idUsuario, imagenBase64, auth);
//
//            if (result.correct) {
//                return ResponseEntity.ok(result);
//            } else {
